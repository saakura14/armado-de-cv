...
import { Camera, Clock, FileCheck2, Mail, MessageCircle, ShieldCheck } from 'lucide-react'
...
const steps = [
  ...
  { title: 'Recibí tu material', text: 'CV en 3 a 4 días hábiles (Express en 24 hs); e-books apenas se confirma el pago.' },
]
...
const topics = [
  ...
  { title: 'Sesión individual de feedback (Zoom)', items: ['Simulacro guiado de entrevista y/o psicotécnico', 'Observación en tiempo real de tu abordaje', 'Feedback inmediato y personalizado', 'Identificación de fortalezas reales', 'Trabajo específico sobre la ansiedad (antes, durante y después)'] },
]
...
const faqs = [
  ...
  { q: '¿Cuánto tarda mi CV?', a: 'Cualquier pack de CV se entrega en 3 a 4 días hábiles desde que se confirma el pago. Si lo necesitás antes, la Versión Express lo entrega dentro de las 24 hs por $15.000 extra.' },
  { q: '¿Hacen el CV en inglés?', a: 'Sí, la versión en inglés es un extra. El precio depende del contenido: consultame por WhatsApp.' },
  ...
  { q: '¿Cómo se agenda el Zoom?', a: 'Las sesiones por Zoom requieren turno previo. Una vez confirmado el pago, coordinamos día y horario por WhatsApp.' },
    ...
    <>
      ...
      <main id="inicio">
        ...
        <section className="relative overflow-hidden">
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.05fr_1fr] lg:py-20">
            <div>
              ...
              <p className="mt-6 flex items-center gap-2 text-sm text-stone"><Clock className="h-4 w-4 text-rose" />Entrega en 3 a 4 días hábiles · Express en 24 hs</p>
            </div>
        ...
        <section id="cv" className="scroll-mt-20 px-4 py-16 sm:px-6 lg:py-24" aria-labelledby="cv-title">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-2">
              ...
              <p className="rounded-3xl bg-rose-wash px-6 py-4 text-center text-sm font-semibold text-rose">Carga de perfil en Zonajobs, Bumeran o Computrabajo: {formatARS(15000)} cada una. Se puede sumar a cualquier pack.</p>
            </div>
          </div>
        </section>
        ...
        <section id="vocacional" className="scroll-mt-20 px-4 py-16 sm:px-6 lg:py-24" aria-labelledby="vocacional-title">
          <div className="mx-auto max-w-6xl">
            <SectionTitle id="vocacional-title" script="Catálogo" title="Test vocacional" text="Una batería de tests para orientarte a la hora de elegir tu camino, con devolución por email o en un encuentro personalizado por Zoom." />
        ...
        <section id="sobre-mi" className="scroll-mt-20 px-4 py-16 sm:px-6 lg:py-24" aria-labelledby="sobre-title">
          <div className="mx-auto grid max-w-5xl items-center gap-10 md:grid-cols-[0.9fr_1.1fr]">
            ...
            <div>
              ...
              <p className="mt-4 leading-relaxed text-stone">Acompaño a personas en su búsqueda laboral: armo CV que pasan los filtros y cuentan bien tu experiencia, preparo para entrevistas y psicotécnicos, y oriento a quienes están eligiendo su camino.</p>
              <p className="mt-3 leading-relaxed text-stone">Mi forma de trabajar es cercana y clara: sabés qué vas a recibir, cuándo y cuánto cuesta. Y si tenés dudas, me escribís.</p>
        ...
        {/* Community */}
        <section className="bg-white px-4 py-14 sm:px-6" aria-labelledby="comunidad-title">
          <div className="mx-auto max-w-5xl">
            <h2 id="comunidad-title" className="text-center text-sm font-semibold uppercase tracking-[0.35em] text-plum">Seguime y enterate de búsquedas</h2>
            <div className="mt-8 grid gap-6 sm:grid-cols-2">
              <a href={`https://instagram.com/${CONTACT.instagram}`} target="_blank" rel="noreferrer" className="flex items-center gap-5 rounded-3xl border border-line bg-paper p-5 hover:border-rose">
                <Image src="/img/qr-instagram.jpg" alt="Código QR de Instagram @armadodecv.ok" width={120} height={160} className="h-32 w-auto rounded-xl" />
                <div><p className="font-bold text-plum">Instagram</p><p className="text-sm text-stone">Tips, novedades y promos en @{CONTACT.instagram}</p></div>
              </a>
              <div className="flex items-center gap-5 rounded-3xl border border-line bg-paper p-5">
                <Image src="/img/qr-canal-whatsapp.jpg" alt="Código QR del canal de WhatsApp Ofertas Laborales Buenos Aires / Argentina" width={90} height={160} className="h-32 w-auto rounded-xl" />
                <div><p className="font-bold text-plum">Canal de WhatsApp</p><p className="text-sm text-stone">Ofertas Laborales Buenos Aires / Argentina. Escaneá el código con la cámara para seguirlo.</p></div>
              </div>
            </div>
          </div>
        </section>
